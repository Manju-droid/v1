...
export const mockDebates: MockDebate[] = [
  {
    ...
    host: {
      ...
      handle: 'tech_debates',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=TechDebates&backgroundColor=b6e3f4',
      isPlatinum: false,
    },
    category: 'Technology',
  ...
  },
  {
    ...
    host: {
      ...
      handle: 'work_culture',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=WorkCulture&backgroundColor=c0aede',
      isPlatinum: false,
    },
    category: 'Lifestyle',
  ...
  },
  {
    ...
    host: {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SocialIssues&backgroundColor=ffd5dc',
      isPlatinum: false,
    },
    category: 'Society',
  ...
  },
  {
    ...
    host: {
      ...
      handle: 'green_tech',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=GreenTech&backgroundColor=b6e3f4',
      isPlatinum: false,
    },
  ...
  },
  {
    ...
    host: {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Economics&backgroundColor=c0aede',
      isPlatinum: false,
    },
    category: 'Politics',
  ...
  },
  {
    ...
    host: {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=CryptoInsights&backgroundColor=ffd5dc',
      isPlatinum: false,
    },
    category: 'Finance',
  ...
  },
  {
    ...
    host: {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ClimateAction&backgroundColor=b6e3f4',
      isPlatinum: false,
    },
    category: 'Environment',
  ...
  },
  {
    ...
    host: {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=EducationHub&backgroundColor=c0aede',
      isPlatinum: false,
    },
    category: 'Education',
