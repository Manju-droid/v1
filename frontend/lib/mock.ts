...
export const mockUsers: MockUser[] = [
  {
    ...
    handle: 'sarah_codes',
    avatar: 'https://api.dicebear.com/9.x/bottts/svg?seed=Sarah&backgroundColor=b6e3f4',
  ...
  },
  {
    ...
    handle: 'alex_designs',
    avatar: 'https://api.dicebear.com/9.x/bottts/svg?seed=Alex&backgroundColor=c0aede',
  ...
  },
  {
    ...
    handle: 'jamie_tech',
    avatar: 'https://api.dicebear.com/9.x/bottts/svg?seed=Jamie&backgroundColor=ffd5dc',
...
export const suggestedUsers: MockUser[] = [
  {
    ...
    handle: 'emma_watson',
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Emma&backgroundColor=b6e3f4',
  ...
  },
  {
    ...
    handle: 'tech_guru',
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=TechGuru&backgroundColor=c0aede',
  ...
  },
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=DesignMaster&backgroundColor=ffd5dc',
  ...
  },
  {
    ...
    handle: 'code_ninja',
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=CodeNinja&backgroundColor=ffdfbf',
  ...
  },
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=StartupFounder&backgroundColor=b6e3f4',
  ...
  },
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=DataScientist&backgroundColor=c0aede',
