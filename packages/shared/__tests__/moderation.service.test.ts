...
import {
  ...
  validateRejectPostRequest,
  validateModerationQueueParams,
  needsModeration,
} from '../src/services/moderation.service';
import type { ReportPostRequest, RejectPostRequest, ModerationQueueParams } from '../src/domain/moderation';
...
describe('validateRejectPostRequest', () => {
  it('should always return valid (no validation needed)', () => {
    const request: RejectPostRequest = {
      postId: 'post1',
      applyPenalty: true,
    };
